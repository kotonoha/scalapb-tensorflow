...
import org.tensorflow.example.feature.{BytesList, Feature, Features, FloatList, Int64List}
...
object TFExample {
  ...
  def f32(data: Float*): Feature = Feature(Kind.FloatList(FloatList(data)))
  def i64seq(data: Seq[Long]): Feature = Feature(Kind.Int64List(Int64List(data)))
